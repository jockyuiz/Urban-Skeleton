...
/// <summary>
/// Original Class definition from KangarooSolver from Kangaroo (by DaneilPiker). 
/// Project Website:https://github.com/Dan-Piker/Kangaroo-examples
/// </summary>
namespace SD_Evaluation.CirclePackings
{
    public class Collider : GoalObject
    {
        ...
        public Collider()
        { }
        public Collider(List<Point3d> Objects, List<double> Radii,  double Strength)
        {
                ...
                if (!IgnoreThisPair)
                {
                    ...
                    if ((ObjectType[Ix0] == 0 && ObjectType[Ix1] == 1) || (ObjectType[Ix0] == 1 && ObjectType[Ix1] == 0))
                    {
                        ...
                        if (SeparationLength < R)
                        {
                            ...
                            t /= Length; //reparametrize t to lie between 0 and 1
